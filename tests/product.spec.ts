...
test('Verify user can view product details', async({page})=>{
    ...
    await expect((app.productDetailsPage.addToCartButton),'Add to cart button is not visible').toBeVisible();
    await expect((app.productDetailsPage.addToFavoritesButton),'Add to favorites button is not visible').toBeVisible();
});
